...
export function SearchSummaryBar() {
  return (
    <div className="bg-white border-b border-slate-200 shadow-sm flex flex-col items-start pb-4 pt-4 px-4 sm:px-6 w-full z-10 sticky top-[65px]">
      <div className="max-w-[1280px] mx-auto w-full">
        {/* Wrap elements on small screens */}
        <div className="flex flex-col lg:flex-row gap-3 lg:gap-4 lg:items-center w-full">
          {/* Destination */}
          ...
          <button className="bg-[#005CBD] hover:bg-blue-800 transition-colors flex items-center justify-center px-8 py-4 lg:py-3 rounded-xl shrink-0 cursor-pointer shadow-md w-full lg:w-auto mt-2 lg:mt-0 border-none">
